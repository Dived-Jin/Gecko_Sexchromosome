# Gecko_sexchromosome
This repository includes some pipelines used in the Gecko genome study, mainly for the phylogeny and the sex chromosome analysis.
...
2. MAF files are merged by Multiz. ([b.LAST_multiz.sh](https://github.com/Dived-Jin/Gecko_Sexchromosome/blob/eb978283d0cedf755deb868efd83e29570673ffb/02.AlignmentLAST/b.LAST_multiz.sh))
...
1. The alignment region extracted from the whole genome alignment. ([a.get_alignment.sh](https://github.com/Dived-Jin/Gecko_Sexchromosome/blob/eb978283d0cedf755deb868efd83e29570673ffb/03.phylogeny/a.get_alignment.sh))
...
1. The case where the sex chromosome is aligned to the  homologous chromosome. ([a.Sexchromsome_alignment_merge.sh](https://github.com/Dived-Jin/Gecko_Sexchromosome/tree/eb978283d0cedf755deb868efd83e29570673ffb/05.Sex_evolution/a.Sexchromsome_alignment_merge.sh))
...
5. The case of the SDR gene cluster. ([e.SDR_gene_classification](https://github.com/Dived-Jin/Gecko_Sexchromosome/tree/eb978283d0cedf755deb868efd83e29570673ffb/05.Sex_evolution/e.SDR_gene_classification))
