...
(2) MAF file merge: b.LAST_muiltz.sh
    used: sh b.LAST_muiltz.sh <maf1list> <Refspecies> <merge_stepfile>
    ...
    In our work, used this script as:
        sh b.LAST_muiltz.sh example/mafpath.txt CORSAR example/merge_step.txt
