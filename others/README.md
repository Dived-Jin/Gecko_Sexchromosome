...
```
(5) nonRandom_sexchromosome_evolution.sh: non-random sex chromosome evolution test.
```
    used: sh nonRandom_sexchromosome_evolution.sh <karyotype file> <SDRfile path>
        - karyotype_file: Ancestral karyotype file was generated by 04.karyotype. Such as example/karyotype.txt.
        - SDRfile path: SDR region of each species. Such as example/CORSAR.bed.
```
(6) Dosage_compensation.sh: The analysis of dosage compensation.
```
